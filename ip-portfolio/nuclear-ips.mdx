...
<Note>
**Primary Reference**: For the unified IP documentation including IP-09 Protocol (Rev-216-OMEGA) and integration matrix, see the [Intellectual Property & IP-09 Protocol Master Reference →](/intellectual-property/ip-protocol-master)
</Note>
